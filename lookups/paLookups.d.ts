export declare const unitClassDescriptions: Readonly<{
...
export declare const realtyTaxClassNames: Readonly<{
    A: "Large Theatre";
    C: "Commercial";
    D: "Office Building";
    E: "Exempt";
...
export declare const realtyTaxQualifiers: Readonly<Record<string, {
    class: 'Taxable' | 'Payment in Lieu';
    name: string;
}>>;
export declare const unitSupportNames: Readonly<{
    P: "English-Public";
    S: "English-Separate";
    A: "French-Public";
    C: "French-Separate";
...
export declare const propertyTypeNames: Readonly<{
    '1': "Residential";
    '2': "Multi-Residential";
    '3': "Commercial";
    '4': "Industrial";
